        ...
        <div class="container">
            ...
            <div class="nav-wrapper container">
                ...
                <ul class="right hide-on-med-and-down">
                    ...
                    <li><a href="monitor.php">Voltar</a></li>
                </ul>
            </div>
        </nav>
    </div>
        ...
        <div class="section">
            ...
            <div class="row">
             ...
             foreach ($lstDados as $dados) {
                 ...
                 echo '<td><a href="    frequencia.php?id_encontro=' . $dados['id_encontro'] . '" class="actions-btn btn-frequency">Frequência</a></td>';
                 echo '<td><a href="excluir.php?id_encontro=' . $dados['id_encontro'] . '" class="actions-btn btn-delete"><img src="../../Crud/crud_encontro/imagens/excluir.png" width="20" height="20" alt="Excluir"></a></td>';
                 echo '</tr>';
             }
             ...
             echo '<div style="margin-top: 20px;">
                 <a href="formcad.php?id_projeto=' . $id_projeto . '" class="actions-btn">Inserir Encontro</a>
             </div>';
